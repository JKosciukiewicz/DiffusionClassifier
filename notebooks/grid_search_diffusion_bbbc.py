...
config_path = "configs/diffusion_bbbc_plg.yaml"
for lr in learning_rates:
    for model in model_size:
        checkpoint_path = f"/net/pr2/projects/plgrid/plggicv/jk/checkpoints_gridsearch_new/bbbc_cp/diffusion/{model}/{lr}"
        run_name = f"gridsearch-bbbc_dino-{model}-{lr}"
        cmd = [
            "python",
            "-m",
