...
# Configuration for Bray DINO Top 3
data_file = "_data/bray_dino/bray_dino_top_3.csv"
...
checkpoint_callback = ModelCheckpoint(
    ...
    monitor="val/roc_auc",
    mode="max",
    dirpath="./checkpoints/bray_dino_top_3/diffusion",
    filename="diffusion-{epoch:02d}-{val/roc_auc:.4f}",
)

logger = WandbLogger(
    project="diffusion_bray_dino",
    name=f"bray_dino_top_3_{split_col}",
)
