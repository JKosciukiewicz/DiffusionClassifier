...
config_path = "configs/conformal_bray_dino_plg.yaml"
for lr in learning_rates:
    for model in model_size:
        checkpoint_path = f"/net/pr2/projects/plgrid/plggicv/jk/checkpoints_gridsearch_new/bray_dino/mlp/{model}/{lr}"
        run_name = f"gridsearch-bray-dino-{model}-{lr}"
        print(run_name)
        cmd = [
            "python",
            "-m",
