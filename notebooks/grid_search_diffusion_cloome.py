...
config_path = "configs/diffusion_bray_cloome_plg.yaml"
for lr in learning_rates:
    for model in model_size:
        checkpoint_path = f"/net/pr2/projects/plgrid/plggicv/jk/checkpoints_gridsearch_new/bray_cloome/diffusion_new/{model}/{lr}"
        run_name = f"gridsearch-bray_cloome-{model}-{lr}"
        cmd = [
            "python",
            "-m",
