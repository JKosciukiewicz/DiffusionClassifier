...
config_path = "configs/conformal_bbbc_dino_plg.yaml"
result_dir_path = "./results_conformal_bbbc_dino"
os.makedirs(result_dir_path, exist_ok=True)
checkpoint_path_full = "/net/pr2/projects/plgrid/plggicv/jk/checkpoints_gridsearch_new/bbbc_dino/mlp/xlg/1e-4/last.ckpt"
