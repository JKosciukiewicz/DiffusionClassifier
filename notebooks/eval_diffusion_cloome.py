...
config_path = "configs/diffusion_bbbc_cloome_plg.yaml"
result_dir_path = "./results_diffusion_bbbc_cloome"
os.makedirs(result_dir_path, exist_ok=True)
checkpoint_path_full = "/net/pr2/projects/plgrid/plggicv/jk/checkpoints_gridsearch_new/bbbc_cloome/diffusion/md/1e-5/last.ckpt"
